...
At the very minimum, write a program that solves the problem. Make it the best use you can of all the clean code principles you know, but also show us your habit on using GIT and everything else you typically use. Feel free to add a section to this README to add some notes from your side. 
